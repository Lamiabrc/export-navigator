...
export const pricePoints: PricePoint[] = [
  // MPL baseline
  mk({ product_id: "p1", productId: "p1", brand: "MPL", market: "FR", channel: "Pharmacie", currency: "EUR", price: 42, price_type: "TTC", priceType: "TTC", date: "2024-12-01", source_label: "Sell-out retail", sourceLabel: "Sell-out retail", confidence: 90 }, 1),
  mk({ product_id: "p1", productId: "p1", brand: "MPL", market: "MQ", channel: "Hospital", currency: "EUR", price: 38, price_type: "HT", priceType: "HT", date: "2024-11-15", source_label: "Distributeur DOM", sourceLabel: "Distributeur DOM", confidence: 82 }, 2),
  mk({ product_id: "p2", productId: "p2", brand: "MPL", market: "FR", channel: "Pharmacie", currency: "EUR", price: 78, price_type: "TTC", priceType: "TTC", date: "2024-12-02", source_label: "Retail panel", sourceLabel: "Retail panel", confidence: 88 }, 3),
  mk({ product_id: "p2", productId: "p2", brand: "MPL", market: "GP", channel: "Hospital", currency: "EUR", price: 72, price_type: "HT", priceType: "HT", date: "2024-11-28", source_label: "Distributeur DOM", sourceLabel: "Distributeur DOM", confidence: 84 }, 4),
  mk({ product_id: "p3", productId: "p3", brand: "MPL", market: "FR", channel: "Pharmacie", currency: "EUR", price: 64, price_type: "TTC", priceType: "TTC", date: "2024-12-03", source_label: "E-commerce", sourceLabel: "E-commerce", confidence: 86 }, 5),
  mk({ product_id: "p3", productId: "p3", brand: "MPL", market: "UE", channel: "Retail", currency: "EUR", price: 58, price_type: "HT", priceType: "HT", date: "2024-11-05", source_label: "Distributeur UE", sourceLabel: "Distributeur UE", confidence: 80 }, 6),
  mk({ product_id: "p4", productId: "p4", brand: "MPL", market: "FR", channel: "Hospital", currency: "EUR", price: 112, price_type: "HT", priceType: "HT", date: "2024-12-01", source_label: "CHU", sourceLabel: "CHU", confidence: 75 }, 7),
  mk({ product_id: "p5", productId: "p5", brand: "MPL", market: "FR", channel: "Pharmacie", currency: "EUR", price: 28, price_type: "TTC", priceType: "TTC", date: "2024-11-20", source_label: "Retail panel", sourceLabel: "Retail panel", confidence: 90 }, 8),
  mk({ product_id: "p6", productId: "p6", brand: "MPL", market: "FR", channel: "Sport", currency: "EUR", price: 22, price_type: "TTC", priceType: "TTC", date: "2024-12-04", source_label: "E-commerce", sourceLabel: "E-commerce", confidence: 87 }, 9),
  mk({ product_id: "p7", productId: "p7", brand: "MPL", market: "FR", channel: "Pharmacie", currency: "EUR", price: 52, price_type: "TTC", priceType: "TTC", date: "2024-12-04", source_label: "Retail panel", sourceLabel: "Retail panel", confidence: 84 }, 10),
  mk({ product_id: "p8", productId: "p8", brand: "MPL", market: "FR", channel: "Hospital", currency: "EUR", price: 134, price_type: "HT", priceType: "HT", date: "2024-12-05", source_label: "CHU", sourceLabel: "CHU", confidence: 78 }, 11),
  mk({ product_id: "p9", productId: "p9", brand: "MPL", market: "UE", channel: "Retail", currency: "EUR", price: 62, price_type: "HT", priceType: "HT", date: "2024-11-18", source_label: "Distributeur UE", sourceLabel: "Distributeur UE", confidence: 80 }, 12),
  mk({ product_id: "p10", productId: "p10", brand: "MPL", market: "GP", channel: "Hospital", currency: "EUR", price: 118, price_type: "HT", priceType: "HT", date: "2024-11-30", source_label: "Distributeur DOM", sourceLabel: "Distributeur DOM", confidence: 77 }, 13),
  mk({ product_id: "p11", productId: "p11", brand: "MPL", market: "FR", channel: "Sport", currency: "EUR", price: 19, price_type: "TTC", priceType: "TTC", date: "2024-12-06", source_label: "Retail panel", sourceLabel: "Retail panel", confidence: 90 }, 14),
