...
export const vatRates: VatRate[] = [
  // UE - autoliquidation
  { destination: 'Belgique', zone: 'UE', rate_standard: 21, rate_lppr: 6, autoliquidation: true, notes: 'Autoliquidation avec TVA intracom' },
  { destination: 'Espagne', zone: 'UE', rate_standard: 21, rate_lppr: 10, autoliquidation: true, notes: 'Autoliquidation avec TVA intracom' },
  { destination: 'Luxembourg', zone: 'UE', rate_standard: 17, rate_lppr: 8, autoliquidation: true, notes: 'Autoliquidation avec TVA intracom' },

  // Suisse
  { destination: 'Suisse', zone: 'Hors UE', rate_standard: 8.1, rate_lppr: 2.5, autoliquidation: false, notes: 'TVA import suisse à payer (non récupérable fournisseur)' },
  ...
  { destination: 'Reunion', zone: 'DROM', rate_standard: 8.5, rate_lppr: 2.1, autoliquidation: false, notes: 'TVA DOM réduite' },
...
export const octroiMerRates: OctroiMerRate[] = [
  // Orthopédie (code 9021) exonérée OM/OMR
  { destination: 'Guadeloupe', category: 'Orthopedie', code_nomenclature: '9021*', om_rate: 0, omr_rate: 0, exoneration_possible: true, notes: 'Dispositifs médicaux exonérés' },
  { destination: 'Martinique', category: 'Orthopedie', code_nomenclature: '9021*', om_rate: 0, omr_rate: 0, exoneration_possible: true, notes: 'Dispositifs médicaux exonérés' },
  { destination: 'Reunion', category: 'Orthopedie', code_nomenclature: '9021*', om_rate: 0, omr_rate: 0, exoneration_possible: true, notes: 'Dispositifs médicaux exonérés' },
  { destination: 'Guyane', category: 'Orthopedie', code_nomenclature: '9021*', om_rate: 0, omr_rate: 0, exoneration_possible: true, notes: 'Dispositifs médicaux exonérés' },
  { destination: 'Mayotte', category: 'Orthopedie', code_nomenclature: '9021*', om_rate: 0, omr_rate: 0, exoneration_possible: true, notes: 'Dispositifs médicaux exonérés' },
  ...
  { destination: 'Guyane', category: 'Standard', code_nomenclature: '*', om_rate: 15, omr_rate: 0, exoneration_possible: false, notes: 'Taux plus élevés' },
...
export const transportCosts: TransportCost[] = [
  ...
  { destination: 'Espagne', transport_mode: 'Routier', cost_per_kg: 0.18, min_cost: 350, transit_days_min: 2, transit_days_max: 4, notes: 'Selon région' },
  ...
  { destination: 'Reunion', transport_mode: 'Maritime', cost_per_kg: 0.50, min_cost: 1200, transit_days_min: 20, transit_days_max: 30, notes: 'Océan Indien' },
  ...
  { destination: 'Reunion', transport_mode: 'Aerien', cost_per_kg: 4.50, min_cost: 350, transit_days_min: 3, transit_days_max: 6, notes: 'Express aérien' },
...
export const serviceCharges: ServiceCharge[] = [
  ...
  { type: 'assurance', zone: 'DROM', fixed_cost: 0, percentage: 0.40, tva_on_service: 0, notes: '% valeur maritime' },
];
...
export const environmentalTaxes: EnvironmentalTax[] = [
  ...
  { type: 'taxe_carbone_ets', transport_mode: 'Aerien', rate_percentage: 1.2, notes: 'ETS aérien (estim.)' },
...
export function getOctroiMerRateForDestination(destination: Destination, isOrthopedic: boolean): OctroiMerRate | undefined {
  ...
  if (isOrthopedic) {
    return rates.find((r) => r.category === 'Orthopedie') || rates.find((r) => r.category === 'Standard');
  }
