...
export const exportCircuits: ExportCircuit[] = [
  {
    ...
    steps: [
      ...
      { id: '2', label: 'Préparation', actor: 'MPL', description: 'Préparation et emballage' },
      { id: '3', label: 'Déclaration export', actor: 'MPL', description: 'Formalités export (EX1)' },
      { id: '4', label: 'Mise à disposition', actor: 'MPL', description: 'Remise au transporteur client' },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: '2', label: 'Préparation', actor: 'MPL', description: 'Prépa + documents' },
      { id: '3', label: 'Export', actor: 'MPL', description: 'EX1' },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: '2', label: 'Préparation export', actor: 'MPL', description: 'Conditionnement' },
      { id: '3', label: 'Export France', actor: 'MPL + LVoverseas', description: 'EX1 + mise FOB' },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: '2', label: 'Vérification TVA', actor: 'MPL', description: 'Contrôle VIES' },
      { id: '3', label: 'Facturation HT', actor: 'MPL', description: 'Mentions exonération' },
      { id: '4', label: 'Préparation', actor: 'MPL', description: 'Docs + emballage' },
      { id: '5', label: 'Transport', actor: 'Geodis/DHL', description: 'Livraison UE' },
      { id: '6', label: 'DEB mensuelle', actor: 'MPL', description: 'Si seuil > 460k€' },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: '2', label: 'Préparation', actor: 'MPL', description: 'Docs FR/DE, EUR.1' },
      { id: '3', label: 'Export France', actor: 'MPL', description: 'EX1 + EUR.1' },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: '2', label: 'Vérification', actor: 'MPL', description: 'Sanctions, certificats' },
      { id: '3', label: 'Préparation', actor: 'MPL', description: 'Docs, emballage' },
      { id: '4', label: 'Export France', actor: 'MPL', description: 'EX1 + préférences' },
