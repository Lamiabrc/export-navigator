    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-8">
      ...
      <div className="mb-8 rounded-2xl border bg-background p-6">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            <div className="text-sm text-muted-foreground">Simulation opérationnelle</div>
          ...
          <CardContent className="space-y-5">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-2">
                ...
                <Input type="number" value={form.productUnitPrice} onChange={onNum("productUnitPrice")} min={0} step="0.01" />
              </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <Input type="number" value={form.preCarriageEur} onChange={onNum("preCarriageEur")} min={0} step="0.01" />
              </div>
              <div className="space-y-2">
                <Label>Transport principal (€)</Label>
                <Input type="number" value={form.mainCarriageEur} onChange={onNum("mainCarriageEur")} min={0} step="0.01" />
              </div>
              ...
              {form.insuranceMode === "rate" ? (
                <div className="space-y-2">
                  ...
                  <Input type="number" value={form.insuranceRatePct} onChange={onNum("insuranceRatePct")} min={0} step="0.01" />
                </div>
              ) : (
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input type="number" value={form.handlingEur} onChange={onNum("handlingEur")} min={0} step="0.01" />
              </div>
              <div className="space-y-2">
                <Label>Autres frais (€)</Label>
                <Input type="number" value={form.otherFeesEur} onChange={onNum("otherFeesEur")} min={0} step="0.01" />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input type="number" value={form.sellingUnitPriceEur} onChange={onNum("sellingUnitPriceEur")} min={0} step="0.01" />
            </div>
          </CardContent>
        </Card>
