...
import { ArrowRight, Globe, Ship, Truck, FileText, Euro } from 'lucide-react';
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="mt-1 text-muted-foreground">
            Types de flux logistiques pour l'exportation - Cliquez sur un circuit pour voir le schéma détaillé et les coûts
          </p>
        </div>
        ...
        <div className="bg-muted/50 rounded-xl p-6">
          <h3 className="font-semibold mb-2">À propos des circuits</h3>
          <p className="text-sm text-muted-foreground">
            Les circuits export représentent les différentes configurations logistiques possibles, 
            indépendamment du client. Chaque circuit définit les responsabilités (qui paie quoi), 
            les documents requis et les étapes du flux. Sélectionnez un circuit pour voir le schéma 
            explicatif complet et l'analyse des coûts.
          </p>
        </div>
      </div>
    </MainLayout>
