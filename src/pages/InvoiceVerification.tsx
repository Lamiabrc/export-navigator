...
export default function InvoiceVerification() {
  ...
  const analyzeFile = useCallback(async () => {
    ...
    try {
      ...
      // ✅ Fallback MPL : recuperer toutes les lignes produit (multi-pages)
      const fallbackItems = parseMplLineItemsFromRawText(rawText);
