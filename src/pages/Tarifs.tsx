    ...
    <PublicLayout>
      <div className="space-y-10">
        <section className="space-y-4">
          <p className="text-xs uppercase tracking-[0.35em] text-blue-200">Tarifs</p>
          <h1 className="text-4xl font-semibold text-white">Des offres claires, sans surprise.</h1>
        ...
        <section className="grid gap-6 md:grid-cols-3">
          {tiers.map((tier) => (
            ...
            >
              <div className="text-sm uppercase tracking-[0.2em] text-blue-200">{tier.name}</div>
              <div className="mt-2 text-2xl font-semibold text-white">{tier.price}</div>
