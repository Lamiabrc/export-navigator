  ...
  const send = async (preset?: string) => {
    ...
    setMessages((prev) => [
      ...prev,
      {
        role: "assistant",
        content: isEn
          ? `Connection in progress. Draft answer for: "${text}". Add destination country, product and HS code for a precise action plan.`
          : `Connexion IA en cours. Première réponse pour : "${text}". Ajoutez le pays destination, le produit et le code HS pour un plan d'action précis.`,
